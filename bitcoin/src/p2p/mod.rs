...
impl Magic {
    /// Briskcoin mainnet network magic bytes
    pub const BITCOIN: Self = Self([0xfb, 0xc0, 0xb6, 0xdb]); // Briskcoin mainnet

    /// Briskcoin testnet network magic bytes
    pub const TESTNET: Self = Self([0xfc, 0xc1, 0xb7, 0xdc]); // Briskcoin testnet

    /// Briskcoin signet network magic bytes
    pub const SIGNET: Self = Self([0xfc, 0xc1, 0xb7, 0xdc]); // Briskcoin signet

    /// Briskcoin regtest network magic bytes
    pub const REGTEST: Self = Self([0xfc, 0xc1, 0xb7, 0xdc]); // Briskcoin regtest
