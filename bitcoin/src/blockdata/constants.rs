...
/// How many seconds between blocks we expect on average (Briskcoin: 30 seconds).
pub const TARGET_BLOCK_SPACING: u32 = 30;
/// How many blocks between diffchanges (Briskcoin: 120 blocks for 1 hour).
pub const DIFFCHANGE_INTERVAL: u32 = 120;
/// How much time on average should occur between diffchanges (Briskcoin: 1 hour).
pub const DIFFCHANGE_TIMESPAN: u32 = 1 * 60 * 60;
...
/// Constructs and returns the coinbase (and only) transaction of the Briskcoin genesis block.
fn bitcoin_genesis_tx() -> Transaction {
    ...
    // Outputs - Using Briskcoin public key
...
mod test {
    ...
    // Test vector for Briskcoin mainnet genesis block hash
    #[test]
